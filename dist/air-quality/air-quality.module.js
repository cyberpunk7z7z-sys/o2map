...
const air_quality_controller_1 = require("./air-quality.controller");
...
exports.AirQualityModule = AirQualityModule = __decorate([
    (0, common_1.Module)({
        controllers: [air_quality_controller_1.AirQualityController],
        providers: [air_quality_service_1.AirQualityService],
        exports: [air_quality_service_1.AirQualityService],
    })
], AirQualityModule);
